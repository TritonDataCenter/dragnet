...
exports.skinnerStream = skinnerStream;
 ...
 */
function streamOptions(useroptions, overrides)
{
	var streamoptions, k;
...
/*
 * Returns a Transform stream that converts from the node-krill plain JS object
 * representation to the "fields" and "value" representation used by
 * node-skinner.
 */
function skinnerStream(options)
{
	var streamoptions, stream;

	streamoptions = streamOptions(options, { 'objectMode': true });
