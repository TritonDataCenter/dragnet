...
DatasourceFile.prototype.checkIndexArgs = function ()
{
...
{
	var error, findstream, querystream, aggr;
	 ...
	 */
	findstream = this.findStream(this.ds_indexpath, 'by_day/%Y/%m/%d/%H',
	     args.timeAfter || null, args.timeBefore || null);
	if (findstream instanceof Error)
		return (mod_dragnet_impl.asyncError(findstream));
	if (args.dryRun)
