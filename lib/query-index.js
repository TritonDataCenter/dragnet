...
{
	var self = this;
	var filter, whenfilter, columns, groupby, stmt, sql, xform, stream;
	...
	mod_vasync.waterfall([
		...
		stmt.each(function (err, row) {
			...
			xform.write(self.deserializeRow(query, row));
		}, function (err) {
			xform.end();
